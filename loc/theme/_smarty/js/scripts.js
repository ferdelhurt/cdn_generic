...
*************************************************** **/
	...
	jQuery(window).ready(function () {
		...
		// Load Bootstrap JS
		loadScript(plugin_path_2 + 'bootstrap/js/bootstrap.min.js', function() {

			// Load Material Design Js
			if(jQuery("body").hasClass('enable-materialdesign')) {
				loadScript(plugin_path_2 + 'mdl/material.min.js');
			}
		...
		if(jQuery("body").hasClass("smoothscroll") && navigator.platform.indexOf('Mac') < 0) {
			...
			loadScript(plugin_path_2 + 'smoothscroll.js', function() {
				jQuery.smoothScroll();
			});
 ...
 **************************************************************** **/
	function _onepageNav() {
		...
		if(_container1.length > 0) {
			...
			loadScript(plugin_path_2 + 'jquery.nav.min.js', function() {
 ...
 **************************************************************** **/
	function _owl_carousel() {
		...
		if(_container.length > 0) {
			...
			loadScript(plugin_path_2 + 'owl-carousel/owl.carousel.min.js', function() {
		...
		if(_container2.length > 0) {
			...
			loadScript(plugin_path_2 + 'owl-carousel-2/owl.carousel.min.js', function() {
 ...
 **************************************************************** **/
	function _flexslider() {
		...
		if(_container.length > 0) {
			...
			loadScript(plugin_path_2 + 'slider.flexslider/jquery.flexslider-min.js', function() {
 ...
 **************************************************************** **/
	function _lightbox() {
		...
		if(_el.length > 0) {
			...
			loadScript(plugin_path_2 + 'magnific-popup/jquery.magnific-popup.min.js', function() {
 ...
 **************************************************************** **/
	function _youtubeBG() {
		...
		if(_container.length > 0) {
			loadScript(plugin_path_2 + 'jquery.mb.YTPlayer.min.js', function() {
 ...
 **************************************************************** **/
	function _mixitup() {
		...
		if(_container.length > 0) {
			loadScript(plugin_path_2 + 'mixitup/jquery.mixitup.min.js', function() {
 ...
 **************************************************************** **/
	function _wrotate() {
		...
		if(_container.length > 0) {
			...
			loadScript(plugin_path_2 + 'text-rotator/jquery.simple-text-rotator.min.js', function() {
 ...
 **************************************************************** **/
	function _lazyload() {
		...
		if(_container.length > 0) {
			loadScript(plugin_path_2 + 'lazyload/jquery.lazyload.min.js', function() {
 ...
 **************************************************************** **/
	function _misc() {
		...
		if(portfolio_isotope_container.length > 0) {
			loadScript(plugin_path_2 + 'isotope/isotope.pkgd.min.js', function() {
		...
		if(file_container.length > 0) {
			loadScript(plugin_path_2 + 'custom.fle_upload.js');
		}
 ...
 **************************************************************** **/
	function _countDown() {
		...
		if(_container.length > 0 || _container2.length > 0) {
			...
			loadScript(plugin_path_2 + 'countdown/jquery.countdown.pack.min.js', function() {
 ...
 **************************************************************** **/
	function _toastr(_message,_position,_notifyType,_onclick) {
		...
		if(_btn.length > 0 && _message != false) {
			...
			loadScript(plugin_path_2 + 'toastr/toastr.js', function() {
				// toastr.clear();
 ...
 **************************************************************** **/
	function _charts() {
		...
		if(_container.length > 0) {
			...
			loadScript(plugin_path_2 + 'chart.easypiechart/dist/jquery.easypiechart.min.js', function() {
 ...
 **************************************************************** **/
	function _select2() {
		...
		if(_container.length > 0) {
			...
			loadScript(plugin_path_2 + 'select2/js/select2.full.min.js', function() {
 ...
 **************************************************************** **/
	function _form() {
		...
		if(jQuery('form.validate-plugin').length > 0) {
			...
			loadScript(plugin_path_2 + 'form.validate/jquery.form.min.js', function() {
				loadScript(plugin_path_2 + 'form.validate/jquery.validation.min.js');
			});
		...
		if(jQuery('form.validate').length > 0) {
			...
			loadScript(plugin_path_2 + 'form.validate/jquery.form.min.js', function() {
				loadScript(plugin_path_2 + 'form.validate/jquery.validation.min.js', function() {
		...
		if(_container.length > 0) {
			...
			loadScript(plugin_path_2 + 'form.masked/jquery.maskedinput.js', function() {
 ...
 **************************************************************** **/
	function _pickers() {
		...
		if(_container_1.length > 0) {
			loadScript(plugin_path_2 + 'bootstrap.datepicker/js/bootstrap-datepicker.min.js', function() {
				...
				if(jQuery().datepicker) {
					...
					_container_1.each(function() {
						...
						if(_lang != 'en' && _lang != '') { // load language file
							loadScript(plugin_path_2 + 'bootstrap.datepicker/locales/bootstrap-datepicker.'+_lang+'.min.js');
						}
		...
		if(_container_2.length > 0) {
			loadScript(plugin_path_2 + 'bootstrap.daterangepicker/moment.min.js', function() {
				loadScript(plugin_path_2 + 'bootstrap.daterangepicker/daterangepicker.js', function() {
		...
		if(_container_3.length > 0) {
			loadScript(plugin_path_2 + 'timepicki/timepicki.min.js', function() {
		...
		if(_container_4.length > 0) {
			loadScript(plugin_path_2 + 'spectrum/spectrum.min.js', function() {
 ...
 **************************************************************** **/
	function _editors() {
		...
		if(_container_1.length > 0) {
			...
			loadScript(plugin_path_2 + 'editor.summernote/summernote.min.js', function() {
				...
				if(jQuery().summernote) {
					...
					_container_1.each(function() {
						...
						alert(_lang);
							loadScript(plugin_path_2 + 'editor.summernote/lang/summernote-'+_lang+'.js');
						}
		...
		if(_container_2.length > 0) {
			...
			loadScript(plugin_path_2 + 'editor.markdown/js/bootstrap-markdown.min.js', function() {
				...
				if(jQuery().markdown) {
					...
					_container_2.each(function() {
						...
						if(_lang != 'en') { // Language!
							loadScript(plugin_path_2 + 'editor.markdown/locale/bootstrap-markdown.'+_lang+'.js');
						}
 ...
 **************************************************************** **/
	function _pajinate() {
		...
		if(_container.length > 0) {
			...
			loadScript(plugin_path_2 + 'pajinate/jquery.pajinate.bootstrap.min.js', function() {
 ...
 **************************************************************** **/
	function _infiniteScroll() {
		...
		if(_container.length > 0) {
			...
			loadScript(plugin_path_2 + 'infinite-scroll/jquery.infinitescroll.min.js', function() {
 ...
 **************************************************************** **/
	function _zoom() {
		...
		if(_container.length > 0) {
			...
			loadScript(plugin_path_2 + 'image.zoom/jquery.zoom.min.js', function() {
 ...
 **************************************************************** **/
	function _autosuggest() {
		...
		if(_container.length > 0) {
			...
			loadScript(plugin_path_2 + 'typeahead.bundle.js', function() {
 ...
 **************************************************************** **/
	function _stepper() {
		...
		if(_container.length > 0) {
			...
			loadScript(plugin_path_2 + 'form.stepper/jquery.stepper.min.js', function() {
 ...
 **************************************************************** **/
	function _slimScroll() {
		...
		if(_container.length > 0) {
			...
			loadScript(plugin_path_2 + 'slimscroll/jquery.slimscroll.min.js', function() {
 ...
 **************************************************************** **/
	function _bgimage() {
		...
		if(_t.length > 0) {
			...
			loadScript(plugin_path_2 + 'jquery.backstretch.min.js', function() {
 ...
 **************************************************************** **/
	function _widget_flickr() {
		...
		if(_container.length > 0) {
			...
			loadScript(plugin_path_2 + 'widget.jflickr/jflickrfeed.min.js', function() {
 ...
 **************************************************************** **/
	function _widget_twitter() {
		...
		if(_container.length > 0) {
			...
			loadScript(plugin_path_2 + 'widget.twittie/twittie.min.js', function() {
 ...
 **************************************************************** **/
	function _widget_dribbble() {
		...
		if(_container.length > 0) {
			...
			loadScript(plugin_path_2 + 'widget.dribbble/jribbble.min.js', function() {
 ...
 **************************************************************** **/
	function _widget_media() {
		...
		if(_container.length > 0) {
			...
			loadScript(plugin_path_2 + 'widget.mediaelementbuild/mediaelement-and-player.min.js', function() {
