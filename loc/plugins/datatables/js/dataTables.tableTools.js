    ...
    var r = function(n) {
        ...
        g.Client.prototype = {
            ...
            positionElement: function() {
                ...
                0 !== a.width && 0 !== a.height && (this.sized = !0, b = this.div.childNodes[0], 
        ...
        TableTools.prototype = {
            ...
            _fnCreateButton: function(a, b) {
                ...
                a.sAction.match(/flash/) ? this._fnFlashConfig(c, a) : "text" == a.sAction ? this._fnTextConfig(c, a) : "div" == a.sAction ? this._fnTextConfig(c, a) : "collection" == a.sAction && (this._fnTextConfig(c, a), 
            ...
            _fnSelectData: function(a) {
                ...
                if (a.nodeName) c = this.s.dt.oInstance.fnGetPosition(a), b.push(this.s.dt.aoData[c]); else if ("undefined" !== typeof a.length) {
                    d = 0;
                    for (f = a.length; d < f; d++) a[d].nodeName ? (c = this.s.dt.oInstance.fnGetPosition(a[d]), 
            ...
            _fnColumnTargets: function(a) {
                ...
                if ("object" == typeof a) {
                    ...
                    d = 0;
                    for (f = c.aoColumns.length; d < f; d++) b.push(c.aoColumns[d].bVisible ? !1 : !0);
                } else if ("sortable" == a) {
                    d = 0;
            ...
            _fnGetDataTablesData: function(a) {
                var b, c, d, f, i, j = [], h = "", g = this.s.dt, k, l = RegExp(a.sFieldBoundary, "g"), m = this._fnColumnTargets(a.mColumns), n = "undefined" != typeof a.bSelectedOnly ? a.bSelectedOnly : !1;
                if (a.bHeader) {
                    i = [];
                    b = 0;
                    for (c = g.aoColumns.length; b < c; b++) m[b] && (h = g.aoColumns[b].sTitle.replace(/\n/g, " ").replace(/<.*?>/g, "").replace(/^\s+|\s+$/g, ""), 
                    h = this._fnHtmlDecode(h), i.push(this._fnBoundData(h, a.sFieldBoundary, l)));
                ...
                for (f = q.length; d < f; d++) {
                    ...
                    i = [];
                    b = 0;
                    for (c = g.aoColumns.length; b < c; b++) m[b] && (h = g.oApi._fnGetCellData(g, q[d], b, "display"), 
                    a.fnCellRender ? h = a.fnCellRender(h, b, k, q[d]) + "" : "string" == typeof h ? (h = h.replace(/\n/g, " "), 
                    h = h.replace(/<img.*?\s+alt\s*=\s*(?:"([^"]+)"|'([^']+)'|([^\s>]+)).*?>/gi, "$1$2$3"), 
                    h = h.replace(/<.*?>/g, "")) : h += "", h = h.replace(/^\s+/, "").replace(/\s+$/, ""), 
                    h = this._fnHtmlDecode(h), i.push(this._fnBoundData(h, a.sFieldBoundary, l)));
                    j.push(i.join(a.sFieldSeperator));
            ...
            _fnPrintStart: function(a) {
                ...
                for (f in d) if ("i" != f && "t" != f && 1 == f.length) for (var i = 0, g = d[f].length; i < g; i++) this.dom.print.hidden.push({
                    node: d[f][i],
                    display: "block"
            ...
            _fnPrintScrollStart: function() {
                ...
                b.style.width = e(a.nTable).outerWidth() + "px", b.style.overflow = "visible");
