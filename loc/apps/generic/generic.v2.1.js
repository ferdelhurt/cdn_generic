...
function cbx_buildrangenumeric(id,ini,end,order)
{
  var a = 0;
  ...
  dend = dend.getFullYear();

  dend = dend + end;

  if(order)
  {
    for (var i=dend; i > ini; i--)
    {
      dtm['id']   = i;
      dtm['ino']  = i;

      dnu[a] = Object.assign({}, dtm);
