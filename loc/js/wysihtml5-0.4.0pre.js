...
window.rangy = function() {
    ...
    function h() {
        if (!q.initialized) {
            var a, d = !1, g = !1;
            b(document, "createRange") && (a = document.createRange(), p(a, n) && t(a, m) && (d = !0), 
            a.detach());
            if ((a = c(document, "body") ? document.body : document.getElementsByTagName("body")[0]) && b(a, "createTextRange")) a = a.createTextRange(), 
            e(a) && (g = !0);
            ...
            for (a = d.length; g < a; ++g) try {
                ...
                c(window, "console") && b(window.console, "log") && window.console.log("Init listener threw an exception. Continuing.", j);
            }
        }
    }
    function i(a) {
    ...
    if (typeof window == k) f("No window found"); else if (typeof document == k) f("No document found"); else return b(document, "addEventListener") && document.addEventListener("DOMContentLoaded", r, !1), 
    b(window, "addEventListener") ? window.addEventListener("load", r, !1) : b(window, "attachEvent") ? window.attachEvent("onload", r) : f("Window does not have required addEventListener or attachEvent method"), 
    q;
}();
...
rangy.createModule("DomUtil", function(b, c) {
    ...
    function d(a, b) {
        ...
        for (d = b; d; d = d.parentNode) if (p(c, d)) return d;
        return null;
    }
    function e(a, b, c) {
    ...
    b.dom = {
        ...
        isHtmlNamespace: function(a) {
            var b;
            return typeof a.namespaceURI == n || null === (b = a.namespaceURI) || "http://www.w3.org/1999/xhtml" == b;
        },
...
rangy.createModule("DomRange", function(b) {
    ...
    function d(a, b, c) {
        if (b = a._listeners[b]) for (var d = 0, e = b.length; d < e; ++d) b[d].call(a, {
            target: a,
            args: c
        });
    }
    ...
    function k(b) {
        for (var c, d = a(b.range).createDocumentFragment(), e; c = b.next(); ) {
            b.isPartiallySelectedSubtree() ? (c = c.cloneNode(!1), e = b.getSubtreeIterator(), 
            c.appendChild(k(e)), e.detach(!0)) : b.remove();
    ...
    function v(a, b) {
        ...
        if (!a.collapsed) {
            ...
            this._first = this._last = this._next = this.sc) : (this._first = this._next = this.sc === c && !l.isCharacterDataNode(this.sc) ? this.sc.childNodes[this.so] : l.getClosestAncestorIn(this.sc, c, !0), 
            this._last = this.ec === c && !l.isCharacterDataNode(this.ec) ? this.ec.childNodes[this.eo - 1] : l.getClosestAncestorIn(this.ec, c, !0));
        }
    }
    function u(a) {
        this.code = this[a];
    ...
    function J(a, b) {
        return function() {
            x(this);
            var c = this.startContainer, d = this.startOffset, e = this.commonAncestorContainer, j = new v(this, !0);
    ...
    function N(a, d, g) {
        ...
        function S(a, b, c) {
            var e = a.endContainer, g = a.endOffset;
        ...
        function i(a, b, c) {
            var e = a.startContainer, g = a.startOffset;
        ...
        b.util.extend(a.prototype, {
            ...
            canSurroundContents: function() {
                ...
                D(this.endContainer);
                var a = new v(this, !0), b = a._first && c(a._first, this) || a._last && c(a._last, this);
                a.detach();
                return !b;
            },
            detach: function() {
            ...
            splitBoundaries: function() {
                x(this);
                var a = this.startContainer, b = this.startOffset, c = this.endContainer, e = this.endOffset, g = a === c;
                l.isCharacterDataNode(c) && (0 < e && e < c.length) && l.splitDataNode(c, e);
                l.isCharacterDataNode(a) && (0 < b && b < a.length) && (a = l.splitDataNode(a, b), 
                g ? (e -= b, c = a) : c == a.parentNode && e >= l.getNodeIndex(a) && e++, b = 0);
                d(this, a, b, c, e);
            },
            normalizeBoundaries: function() {
                x(this);
                var a = this.startContainer, b = this.startOffset, c = this.endContainer, e = this.endOffset, g = function(a) {
                    var b = a.nextSibling;
                    ...
                    if (g && g.nodeType == d.nodeType) {
                        ...
                        a == c ? (e += b, c = a) : c == d.parentNode && (g = l.getNodeIndex(d), e == g ? (c = d, 
                        e = j) : e > g && e--);
                    }
                }, f = !0;
                l.isCharacterDataNode(c) ? c.length == e && g(c) : (0 < e && (f = c.childNodes[e - 1]) && l.isCharacterDataNode(f) && g(f), 
                f = !this.collapsed);
                f ? l.isCharacterDataNode(a) ? 0 == b && j(a) : b < a.childNodes.length && (g = a.childNodes[b]) && l.isCharacterDataNode(g) && j(g) : (a = c, 
                b = e);
                d(this, a, b, c, e);
            },
    ...
    function O(a, b, c, e, g) {
        var j = a.startContainer !== b || a.startOffset !== c, f = a.endContainer !== e || a.endOffset !== g;
        a.startContainer = b;
        a.startOffset = c;
        a.endContainer = e;
        a.endOffset = g;
    ...
    v.prototype = {
        ...
        next: function() {
            ...
            a && (this._next = a !== this._last ? a.nextSibling : null, l.isCharacterDataNode(a) && this.clonePartiallySelectedTextNodes && (a === this.ec && (a = a.cloneNode(!0)).deleteData(this.eo, a.length - this.eo), 
            this._current === this.sc && (a = a.cloneNode(!0)).deleteData(0, this.so)));
            return a;
        },
        remove: function() {
            var a = this._current, b, c;
            l.isCharacterDataNode(a) && (a === this.sc || a === this.ec) ? (b = a === this.sc ? this.so : 0, 
            c = a === this.ec ? this.eo : a.length, b != c && a.deleteData(b, c - b)) : a.parentNode && a.parentNode.removeChild(a);
        },
        ...
        getSubtreeIterator: function() {
            ...
            if (this.isSingleCharacterDataNode) b = this.range.cloneRange(), b.collapse(); else {
                ...
                var c = this._current, d = c, e = 0, g = c, j = l.getNodeLength(c);
    ...
    var E = [ 1, 3, 4, 5, 7, 8, 10 ], M = [ 2, 9, 11 ], F = [ 1, 3, 4, 5, 7, 8, 10, 11 ], P = [ 1, 3, 4, 5, 7, 8 ], K = l.getRootContainer, I = r([ 9, 11 ]), T = r([ 5, 6, 10, 12 ]), L = r([ 6, 10, 12 ]), S = document.createElement("style"), W = !1;
    try {
        S.innerHTML = "<b>x</b>", W = 3 == S.firstChild.nodeType;
    } catch (da) {}
    b.features.htmlParsingConforms = W;
    var X = "startContainer startOffset endContainer endOffset collapsed commonAncestorContainer".split(" "), U = 0, Y = 1, ca = 2, Z = 3, $ = 0, aa = 1, ba = 2, V = 3;
    G.prototype = {
        ...
        compareBoundaryPoints: function(a, b) {
            ...
            var c = a == Z || a == U ? "start" : "end", d = a == Y || a == U ? "start" : "end";
        ...
        cloneContents: function() {
            ...
            if (this.startContainer === this.endContainer && l.isCharacterDataNode(this.startContainer)) return b = this.startContainer.cloneNode(!0), 
            b.data = b.data.slice(this.startOffset, this.endOffset), c = a(this).createDocumentFragment(), 
            c.appendChild(b), c;
            c = new v(this, !0);
            b = i(c);
            c.detach();
        ...
        createContextualFragment: W ? function(a) {
        ...
        intersectsNode: function(b, c) {
            ...
            var d = b.parentNode, e = l.getNodeIndex(b);
            z(d, "NOT_FOUND_ERR");
            var g = l.comparePoints(d, e, this.endContainer, this.endOffset), d = l.comparePoints(d, e + 1, this.startContainer, this.startOffset);
        ...
        intersectsRange: function(b, c) {
            ...
            var d = l.comparePoints(this.startContainer, this.startOffset, b.endContainer, b.endOffset), e = l.comparePoints(this.endContainer, this.endOffset, b.startContainer, b.startOffset);
        ...
        containsNodeText: function(a) {
            ...
            b.selectNode(a);
            var c = b.getNodes([ 3 ]);
            return 0 < c.length ? (b.setStart(c[0], 0), a = c.pop(), b.setEnd(a, a.length), 
            a = this.containsRange(b), b.detach(), a) : this.containsNodeContents(a);
        },
...
rangy.createModule("WrappedRange", function(b) {
    function c(a, b, c, d) {
        ...
        var b = e.getDocument(j).createElement("span"), h, k = c ? "StartToStart" : "StartToEnd";
        do {
            j.insertBefore(b, b.previousSibling), g.moveToElementText(b);
        } while (0 < (h = g.compareEndPoints(k, a)) && b.previousSibling);
        k = b.nextSibling;
        if (-1 == h && k && e.isCharacterDataNode(k)) {
            ...
            if (/[\r\n]/.test(k.data)) {
                j = g.duplicate();
                c = j.text.replace(/\r\n/g, "\r").length;
                for (c = j.moveStart("character", c); -1 == j.compareEndPoints("StartToEnd", j); ) c++, 
    ...
    function a(a, b) {
        var c, d, g = a.offset, j = e.getDocument(a.node), f = j.body.createTextRange(), h = e.isCharacterDataNode(a.node);
        h ? (c = a.node, d = c.parentNode) : (c = a.node.childNodes, c = g < c.length ? c[g] : null, 
        d = a.node);
    ...
    if (b.features.implementsDomRange && (!b.features.implementsTextRange || !b.config.preferTextRange)) {
        var i = function(a) {
            for (var b = j.length, c; b--; ) c = j[b], a[c] = a.nativeRange[c];
        ...
        g.selectNodeContents = n.startContainer == m && n.endContainer == m && 0 == n.startOffset && n.endOffset == m.length ? function(a) {
        ...
        0 == this.textRange.compareEndPoints("StartToEnd", this.textRange) ? b = a = c(this.textRange, b, !0, !0) : (a = c(this.textRange, b, !0, !1), 
        b = c(this.textRange, b, !1, !1));
...
rangy.createModule("WrappedSelection", function(b, c) {
    ...
    function h(a) {
        var c;
        a instanceof t ? (c = a._selectionNativeRange, c || (c = b.createNativeRange(p.getDocument(a.startContainer)), 
        c.setEnd(a.endContainer, a.endOffset), c.setStart(a.startContainer, a.startOffset), 
        a._selectionNativeRange = c, a.attachListener("detach", function() {
    ...
    function i(a) {
        ...
        a: if (!b.length || 1 != b[0].nodeType) c = !1; else {
            c = 1;
            for (var d = b.length; c < d; ++c) if (!p.isAncestorOf(b[0], b[c])) {
                c = !1;
                break a;
            }
            c = !0;
    ...
    function j(a) {
        ...
        if ("None" == a.docSelection.type) f(a); else {
            ...
            if (c && "undefined" != typeof c.text) g(a, c); else {
                ...
                for (var d, j = p.getDocument(c.item(0)), h = 0; h < a.rangeCount; ++h) d = b.createRange(j), 
                d.selectNode(c.item(h)), a._ranges.push(d);
    ...
    function u(a) {
        var b = [], c = new A(a.anchorNode, a.anchorOffset), d = new A(a.focusNode, a.focusOffset), e = "function" == typeof a.getName ? a.getName() : "Selection";
        if ("undefined" != typeof a.rangeCount) for (var g = 0, j = a.rangeCount; g < j; ++g) b[g] = t.inspect(a.getRangeAt(g));
    ...
    r.isHostMethod(z, "getRangeAt") ? P = function(a, b) {
        ...
        var c = p.getDocument(a.anchorNode), c = b.createRange(c);
        c.setStart(a.anchorNode, a.anchorOffset);
        c.setEnd(a.focusNode, a.focusOffset);
        c.collapsed !== this.isCollapsed && (c.setStart(a.focusNode, a.focusOffset), c.setEnd(a.anchorNode, a.anchorOffset));
        return c;
    });
    b.getSelection = function(a) {
        var a = a || window, b = a._rangySelection, c = B(a), e = x ? d(a) : null;
        b ? (b.nativeSelection = c, b.docSelection = e, b.refresh(a)) : (b = new m(c, e, a), 
        a._rangySelection = b);
        return b;
    };
    ...
    if (!G && J && r.areHostMethods(z, [ "removeAllRanges", "addRange" ])) {
        ...
        var K = function(a, c) {
            var d = t.getRangeDocument(c), d = b.createRange(d);
        ...
        s.addRange = R ? function(a, c) {
            if (F && x && "Control" == this.docSelection.type) k(this, a); else if (c && N) K(this, a); else {
                var d;
                O ? d = this.rangeCount : (this.removeAllRanges(), d = 0);
                this.nativeSelection.addRange(h(a));
                this.rangeCount = this.nativeSelection.rangeCount;
                this.rangeCount == d + 1 ? (b.config.checkSelectionRanges && (d = P(this.nativeSelection, this.rangeCount - 1)) && !t.rangesEqual(d, a) && (a = new q(d)), 
                this._ranges[this.rangeCount - 1] = a, e(this, a, L(this.nativeSelection)), this.isCollapsed = D(this)) : this.refresh();
            }
        } : function(a, b) {
            b && N ? K(this, a) : (this.nativeSelection.addRange(h(a)), this.refresh());
        };
        s.setRanges = function(a) {
            if (F && 1 < a.length) n(this, a); else {
        ...
        "Control" == this.docSelection.type ? k(this, a) : (q.rangeToTextRange(a).select(), 
        this._ranges[0] = a, this.rangeCount = 1, this.isCollapsed = this._ranges[0].collapsed, 
        e(this, a, !1));
    }, s.setRanges = function(a) {
        this.removeAllRanges();
        var b = a.length;
    ...
    if (G) I = function(a) {
        var c;
        b.isSelectionValid(a.win) ? c = a.docSelection.createRange() : (c = p.getBody(a.win.document).createTextRange(), 
        c.collapse(!0));
        "Control" == a.docSelection.type ? j(a) : c && "undefined" != typeof c.text ? g(a, c) : f(a);
    }; else if (r.isHostMethod(z, "getRangeAt") && "number" == typeof z.rangeCount) I = function(a) {
        if (F && x && "Control" == a.docSelection.type) j(a); else if (a._ranges.length = a.rangeCount = a.nativeSelection.rangeCount, 
        a.rangeCount) {
    ...
    }; else if (J && "boolean" == typeof z.isCollapsed && "boolean" == typeof Q.collapsed && b.features.implementsDomRange) I = function(a) {
        var b;
        b = a.nativeSelection;
        b.anchorNode ? (b = P(b, 0), a._ranges = [ b ], a.rangeCount = 1, b = a.nativeSelection, 
        a.anchorNode = b.anchorNode, a.anchorOffset = b.anchorOffset, a.focusNode = b.focusNode, 
        a.focusOffset = b.focusOffset, a.isCollapsed = D(a)) : f(a);
    }; else return c.fail("No means of obtaining a Range or TextRange from the user's selection was found"), 
    !1;
    ...
    s.removeRange = F ? function(a) {
        if ("Control" == this.docSelection.type) {
            for (var b = this.docSelection.createRange(), a = i(a), c = p.getDocument(b.item(0)), c = p.getBody(c).createControlRange(), d, e = !1, g = 0, f = b.length; g < f; ++g) d = b.item(g), 
            d !== a || e ? c.add(b.item(g)) : e = !0;
            c.select();
            j(this);
        } else T(this, a);
    } : function(a) {
    ...
    var L;
    !G && J && b.features.implementsDomRange ? (L = function(a) {
        var b = !1;
    ...
    s.deleteFromDocument = function() {
        if (F && x && "Control" == this.docSelection.type) {
            for (var a = this.docSelection.createRange(), b; a.length; ) b = a.item(0), a.remove(b), 
            b.parentNode.removeChild(b);
            this.refresh();
    ...
    s.toHtml = function() {
        var a = "";
        if (this.rangeCount) {
            for (var a = t.getRangeDocument(this._ranges[0]).createElement("div"), b = 0, c = this._ranges.length; b < c; ++b) a.appendChild(this._ranges[b].cloneContents());
            a = a.innerHTML;
        }
        return a;
    };
...
Base.extend = function(b, c) {
    ...
    var e = d.constructor, f = d.constructor = function() {
        ...
        e.apply(this, arguments), delete this._constructing; else if (null != arguments[0]) return (arguments[0].extend || a).call(arguments[0], d);
    };
    f.ancestor = this;
...
wysihtml5.browser = function() {
    var b = navigator.userAgent, c = document.createElement("div"), a = -1 !== b.indexOf("MSIE") && -1 === b.indexOf("Opera"), d = -1 !== b.indexOf("Gecko") && -1 === b.indexOf("KHTML"), e = -1 !== b.indexOf("AppleWebKit/"), f = -1 !== b.indexOf("Chrome/"), h = -1 !== b.indexOf("Opera/"), i = {
        formatBlock: a,
...
(function(b) {
    function c(i) {
        if (!a.contains(i.nodeName)) if (i.nodeType === b.TEXT_NODE && i.data.match(d)) {
...
wysihtml5.dom.convertToList = function() {
    ...
    return function(c, a) {
        ...
        for (m = 0; m < h; m++) for (i = f[m]; (g = i.parentNode) && g !== c && g.lastChild === i; ) {
        ...
        h = f.length;
        for (m = 0; m < h; m++) k = k || b(d, e), i = f[m], g = "block" === wysihtml5.dom.getStyle("display").from(i), 
        j = "BR" === i.nodeName, g ? (k = k.firstChild ? b(d, e) : k, k.appendChild(i), 
        k = null) : j ? k = k.firstChild ? null : k : k.appendChild(i);
        0 === f.length && b(d, e);
    ...
    b.copyStyles = function(a) {
        return {
            from: function(d) {
                ...
                b: {
                    e = 0;
                    for (var f = c.length; e < f; e++) if ("border-box" === b.getStyle(c[e]).from(d)) {
                        e = c[e];
                        break b;
                    }
                    e = void 0;
...
wysihtml5.dom.getAsDom = function() {
    ...
    return function(c, a) {
        var a = a || document, d;
        if ("object" === typeof c && c.nodeType) d = a.createElement("div"), d.appendChild(c); else if (wysihtml5.browser.supportsHTML5Tags(a)) d = a.createElement("div"), 
        d.innerHTML = c; else {
            d = a;
        ...
        return {
            from: function(d) {
                if (d.nodeType === wysihtml5.ELEMENT_NODE) {
                    var e = d.ownerDocument, f = b[a] || a.replace(c, function(a) {
                    ...
                    if (f.getComputedStyle) return e && (k = h.overflow, h.overflow = "hidden"), d = f.getComputedStyle(d, null).getPropertyValue(a), 
                    e && (h.overflow = k || ""), d;
                }
            }
        };
...
wysihtml5.dom.observe = function(b, c, a) {
    for (var c = "string" === typeof c ? [ c ] : c, d, e, f = 0, h = c.length; f < h; f++) e = c[f], 
    b.addEventListener ? b.addEventListener(e, a, !1) : (d = function(c) {
    ...
    return {
        stop: function() {
            for (var e, g = 0, f = c.length; g < f; g++) e = c[g], b.removeEventListener ? b.removeEventListener(e, a, !1) : b.detachEvent("on" + e, d);
        }
    };
};
...
wysihtml5.dom.parse = function() {
    function b(c, e) {
        var g = c.childNodes, f = g.length, j = a[c.nodeType], h = 0, k, j = j && j(c);
        if (!j) return null;
    ...
    var a = {
        1: function(a) {
            ...
            var j = {}, f = b.set_class, k = b.add_class, i = b.set_attributes, m = b.check_attributes, n = h.classes, p = 0, t = [];
            b = [];
            var u = [], r = [], w;
            i && (j = wysihtml5.lang.object(i).clone());
            if (m) for (w in m) if (i = v[m[w]]) i = i(c(a, w)), "string" === typeof i && (j[w] = i);
            f && t.push(f);
            if (k) for (w in k) if (i = q[k[w]]) f = i(c(a, w)), "string" === typeof f && t.push(f);
            n["_wysihtml5-temp-placeholder"] = 1;
            (r = a.getAttribute("class")) && (t = t.concat(r.split(e)));
        ...
        tags: {},
        classes: {}
    }, h = {}, i = !wysihtml5.browser.supportsGetAttributeCorrectly(), g = /^https?:\/\//i, j = /^(\/|https?:\/\/)/i, k = /^(\/|https?:\/\/|mailto:)/i, m = /[^ a-z0-9_\-]/gi, n = /\D/g, v = {
        url: function(a) {
    ...
    return function(a, c, d, e) {
        ...
        for (var d = d || a.ownerDocument || document, c = d.createDocumentFragment(), g = "string" === typeof a, a = g ? wysihtml5.dom.getAsDom(a, d) : a; a.firstChild; ) d = a.firstChild, 
        a.removeChild(d), (d = b(d, e)) && c.appendChild(d);
        a.innerHTML = "";
        a.appendChild(c);
...
wysihtml5.dom.removeEmptyTextNodes = function(b) {
    for (var c = wysihtml5.lang.array(b.childNodes).get(), a = c.length, d = 0; d < a; d++) b = c[d], 
...
(function(b) {
    ...
    b.resolveList = function(a, d) {
        if (a.nodeName.match(/^(MENU|UL|OL)$/)) {
            ...
            if (d) for (h && "block" !== b.getStyle("display").from(h) && c(f); g = a.firstElementChild || a.firstChild; ) {
                for (e = g.lastChild; h = g.firstChild; ) i = (i = h === e) && "block" !== b.getStyle("display").from(h) && "BR" !== h.nodeName, 
                f.appendChild(h), i && c(f);
                g.parentNode.removeChild(g);
            } else for (;g = a.firstElementChild || a.firstChild; ) {
                if (g.querySelector && g.querySelector("div, p, ul, ol, menu, blockquote, h1, h2, h3, h4, h5, h6")) for (;h = g.firstChild; ) f.appendChild(h); else {
    ...
    b.dom.Sandbox = Base.extend({
        ...
        _onLoadIframe: function(f) {
            if (b.dom.contains(c.documentElement, f)) {
                var h = this, i = f.contentWindow, g = f.contentWindow.document, j = this._getHtml({
        ...
        _getHtml: function(a) {
            var c = a.stylesheets, d = "", e = 0, j;
            if (c = "string" === typeof c ? [ c ] : c) for (j = c.length; e < j; e++) d += '<link rel="stylesheet" href="' + c[e] + '">';
            a.stylesheets = d;
...
wysihtml5.dom.setStyles = function(b) {
    return {
        on: function(c) {
            c = c.style;
            if ("string" === typeof b) c.cssText += ";" + b; else for (var a in b) "float" === a ? (c.cssFloat = b[a], 
            c.styleFloat = b[a]) : c[a] = b[a];
        }
    };
};
...
(function(b) {
    b.quirks.getCorrectInnerHTML = function(c) {
        ...
        h = 0;
        for (f = c.length; h < f; h++) d = c[h].href || c[h].src, e = b.lang.string(d).replace("~").by("%7E"), 
        a = b.lang.string(a).replace(e).by(d);
        return a;
    };
})(wysihtml5);
...
(function(b) {
    ...
    b.Selection = Base.extend({
        ...
        executeAndRestore: function(a, d) {
            ...
            if (g) {
                b.browser.hasInsertNodeIssue() ? this.doc.execCommand("insertHTML", !1, i) : (i = g.createContextualFragment(i), 
                g.insertNode(i));
                try {
                ...
                (g = this.doc.querySelector("._wysihtml5-temp-placeholder")) ? (i = rangy.createRange(this.doc), 
                j = g.nextSibling, b.browser.hasInsertNodeIssue() && j && "BR" === j.nodeName ? (j = this.doc.createTextNode(b.INVISIBLE_SPACE), 
                c.insert(j).after(g), i.setStartBefore(j), i.setEndBefore(j)) : (i.selectNode(g), 
                i.deleteContents()), this.setSelection(i)) : e.focus();
...
(function(b, c) {
    ...
    function d(a, b, e) {
        var f;
        c.dom.isCharacterDataNode(b) && (0 == e ? (e = c.dom.getNodeIndex(b), b = b.parentNode) : e == b.length ? (e = c.dom.getNodeIndex(b) + 1, 
        b = b.parentNode) : f = c.dom.splitDataNode(b, e));
        if (!f) {
            f = b.cloneNode(!1);
    ...
    e.prototype = {
        doMerge: function() {
            for (var a = [], b, c, d = 0, e = this.textNodes.length; d < e; ++d) b = this.textNodes[d], 
            c = b.parentNode, a[d] = b.data, d && (c.removeChild(b), c.hasChildNodes() || c.parentNode.removeChild(c));
    ...
    f.prototype = {
        getAncestorWithClass: function(a) {
            for (var d; a; ) {
                ...
                if (a.nodeType == b.ELEMENT_NODE && c.dom.arrayContains(this.tagNames, a.tagName.toLowerCase()) && d) return a;
                a = a.parentNode;
            }
            return !1;
        },
        postApply: function(a, b) {
            for (var c = a[0], d = a[a.length - 1], f = [], h, i = c, p = d, r = 0, t = d.length, q, y, A = 0, B = a.length; A < B; ++A) q = a[A], 
            (y = this.getAdjacentMergeableTextNode(q.parentNode, !1)) ? (h || (h = new e(y), 
            f.push(h)), h.textNodes.push(q), q === c && (i = h.firstTextNode, r = i.length), 
            q === d && (p = h.firstTextNode, t = h.getLength())) : h = null;
            if (c = this.getAdjacentMergeableTextNode(d.parentNode, !0)) h || (h = new e(d), 
            f.push(h)), h.textNodes.push(c);
            if (f.length) {
                A = 0;
                for (B = f.length; A < B; ++A) f[A].doMerge();
                b.setStart(i, r);
                b.setEnd(p, t);
            }
        },
        ...
        areElementsMergeable: function(a, b) {
            var d;
            if (d = c.dom.arrayContains(this.tagNames, (a.tagName || "").toLowerCase())) if (d = c.dom.arrayContains(this.tagNames, (b.tagName || "").toLowerCase())) if (d = a.className.replace(i, " ") == b.className.replace(i, " ")) a: if (a.attributes.length != b.attributes.length) d = !1; else {
                d = 0;
                for (var e = a.attributes.length, f, h; d < e; ++d) if (f = a.attributes[d], h = f.name, 
                "class" != h && (h = b.attributes.getNamedItem(h), f.specified != h.specified || f.specified && f.nodeValue !== h.nodeValue)) {
                    d = !1;
                    break a;
                }
                d = !0;
        ...
        applyToTextNode: function(a) {
            var b = a.parentNode;
            1 == b.childNodes.length && c.dom.arrayContains(this.tagNames, b.tagName.toLowerCase()) ? this.cssClass && (a = this.cssClass, 
            b.className ? (b.className && (b.className = b.className.replace(this.similarClassRegExp, "")), 
            b.className += " " + a) : b.className = a) : (b = this.createContainer(c.dom.getDocument(a)), 
        ...
        undoToTextNode: function(b, c, e) {
            c.containsNode(e) || (b = c.cloneRange(), b.selectNode(e), b.isPointInRange(c.endContainer, c.endOffset) && a(c.endContainer, c.endOffset) && (d(e, c.endContainer, c.endOffset), 
            c.setEndAfter(e)), b.isPointInRange(c.startContainer, c.startOffset) && a(c.startContainer, c.startOffset) && (e = d(e, c.startContainer, c.startOffset)));
        ...
        undoToRange: function(a) {
            var c = a.getNodes([ b.TEXT_NODE ]), d, e;
            c.length ? (a.splitBoundaries(), c = a.getNodes([ b.TEXT_NODE ])) : (c = a.endContainer.ownerDocument.createTextNode(b.INVISIBLE_SPACE), 
            a.insertNode(c), a.selectNode(c), c = [ c ]);
            for (var f = 0, h = c.length; f < h; ++f) d = c[f], (e = this.getAncestorWithClass(d)) && this.undoToTextNode(d, a, e);
            1 == h ? this.selectNode(a, c[0]) : (a.setStart(c[0], 0), d = c[c.length - 1], a.setEnd(d, d.length), 
            this.normalize && this.postApply(c, a));
        },
        selectNode: function(a, c) {
            var d = c.nodeType === b.ELEMENT_NODE, e = "canHaveHTML" in c ? c.canHaveHTML : !0, f = d ? c.innerHTML : c.data;
        ...
        exec: function(a, d, e) {
            ...
            if (f) a.selection.executeAndRestore(function() {
                ...
                var d = e = "object" === typeof e ? e : {
                    href: e
                }, e = a.doc, h = "_wysihtml5-temp-" + +new Date(), i = 0, g, j, k;
                b.commands.formatInline.exec(a, void 0, "A", h, /non-matching-class/g);
                g = e.querySelectorAll("A." + h);
                for (h = g.length; i < h; i++) for (k in j = g[i], j.removeAttribute("class"), d) j.setAttribute(k, d[k]);
                k = j;
                1 === h && (h = c.getTextContent(j), i = !!j.querySelector("*"), h = "" === h || h === b.INVISIBLE_SPACE, 
                !i && h && (c.setTextContent(j, d.text || j.href), d = e.createTextNode(" "), a.selection.setAfter(j), 
                c.insert(d).after(j), k = d));
        ...
        exec: function(h, i, g, j, k) {
            ...
            if (n) h.selection.executeAndRestoreSimple(function() {
                ...
                if (!b.lang.string(n.className).trim() && (v || "P" === g)) {
                    var f = n, h = f.ownerDocument, j = a(f), i = c(f);
                ...
                if (null === g || b.lang.array(f).contains(g)) if (p = h.selection.getSelectedNode(), 
                ...
                if (h.commands.support(i)) {
                    ...
                    m.execCommand(i, !1, h);
                    r && r.stop();
                } else n = m.createElement(g || u), j && (n.className = j), i = n, h.selection.selectLine(), 
                h.selection.surround(i), m = a(i), r = c(i), m && "BR" === m.nodeName && m.parentNode.removeChild(m), 
                r && "BR" === r.nodeName && r.parentNode.removeChild(r), (m = i.lastChild) && "BR" === m.nodeName && m.parentNode.removeChild(m), 
                h.selection.selectNode(i, b.browser.displaysCaretInEmptyContentEditableCorrectly());
            }
        },
...
(function(b) {
    function c(c, f, h) {
        var i = c + ":" + f;
        if (!d[i]) {
            var g = d, j = b.selection.HTMLApplier, k = a[c], c = k ? [ c.toLowerCase(), k.toLowerCase() ] : [ c.toLowerCase() ];
            g[i] = new j(c, f, h, !0);
        }
        return d[i];
    }
    ...
    b.commands.formatInline = {
        ...
        state: function(d, f, h, i, g) {
            var f = d.doc, j = a[h] || h;
            if (!b.dom.hasElementWithTagName(f, h) && !b.dom.hasElementWithTagName(f, j) || i && !b.dom.hasElementWithClassName(f, i)) return !1;
...
(function(b) {
    b.commands.insertImage = {
        exec: function(c, a, d) {
            ...
            if (a) c.selection.setBefore(a), d = a.parentNode, d.removeChild(a), b.dom.removeEmptyTextNodes(d), 
            "A" === d.nodeName && !d.firstChild && (c.selection.setAfter(d), d.parentNode.removeChild(d)), 
            b.quirks.redraw(c.element); else {
...
wysihtml5.commands.insertOrderedList = {
    exec: function(b, c) {
        var a = b.doc, d = b.selection.getSelectedNode(), e = wysihtml5.dom.getParentElement(d, {
            nodeName: "OL"
        }), f = wysihtml5.dom.getParentElement(d, {
            nodeName: "UL"
        }), d = "_wysihtml5-temp-" + new Date().getTime(), h;
        ...
        }) : (b.commands.exec("formatBlock", "div", d), h = a.querySelector("." + d), a = "" === h.innerHTML || h.innerHTML === wysihtml5.INVISIBLE_SPACE || "<br>" === h.innerHTML, 
...
(function(b) {
    ...
    b.UndoManager = b.lang.Dispatcher.extend({
            ...
            if (b.browser.hasUndoInContextMenu()) {
                ...
                d.observe(this.element, "contextmenu", function() {
                    ...
                    i = setInterval(function() {
                        f.getElementById("_wysihtml5-redo") ? (j(), e.redo()) : f.getElementById("_wysihtml5-undo") || (j(), 
                        e.undo());
                    }, 400);
        ...
        transact: function() {
            var a = this.historyStr[this.position - 1], c = this.composer.getValue();
            if (c !== a) {
                if (25 < (this.historyStr.length = this.historyDom.length = this.position)) this.historyStr.shift(), 
                this.historyDom.shift(), this.position--;
                this.position++;
                var d = this.composer.selection.getRange(), a = d.startContainer || this.element, i = d.startOffset || 0, g;
                ...
                "undefined" !== typeof g && d.setAttribute("data-wysihtml5-selection-node", g);
        ...
        set: function(a) {
            ...
            a.hasAttribute("data-wysihtml5-selection-offset") ? (b = a.getAttribute("data-wysihtml5-selection-offset"), 
            c = a.getAttribute("data-wysihtml5-selection-node"), a = this.element) : (a = this.element.querySelector("[data-wysihtml5-selection-offset]") || this.element, 
            b = a.getAttribute("data-wysihtml5-selection-offset"), c = a.getAttribute("data-wysihtml5-selection-node"), 
        ...
        getChildNodeIndex: function(a, b) {
            for (var c = 0, d = a.childNodes, g = d.length; c < g; c++) if (d[c] === b) return c;
        },
        ...
        _initAutoLinking: function() {
            ...
            if (this.config.autoLink) {
                if (!f || f && e) this.parent.on("newword:composer", function() {
                    c.getTextContent(d.element).match(c.autoLink.URL_REG_EXP) && d.selection.executeAndRestore(function(a, b) {
        ...
        _initObjectResizing: function() {
            ...
            if (a.supportsEvent("resizeend")) {
                ...
                c.observe(f, "resizeend", function(a) {
                    var a = a.target || a.srcElement, c = a.style, g = 0, j;
                    if ("IMG" === a.nodeName) {
        ...
        _initLineBreaking: function() {
            ...
            this.config.useLineBreaks || c.observe(this.element, [ "focus", "keydown" ], function() {
                if (e.isEmpty()) {
                    ...
                    a.displaysCaretInEmptyContentEditableCorrectly() ? e.selection.selectNode(b, !0) : (b.innerHTML = "<br>", 
                    e.selection.setBefore(b.firstChild));
                }
            });
            c.observe(this.doc, "keydown", function(a) {
                ...
                if (!a.shiftKey && !(g !== b.ENTER_KEY && g !== b.BACKSPACE_KEY)) {
                    ...
                    j ? setTimeout(function() {
                        var a = e.selection.getSelectedNode(), f;
                        if ("LI" === j.nodeName) {
                            if (!a) return;
                    ...
                    }, 0) : e.config.useLineBreaks && (g === b.ENTER_KEY && !b.browser.insertsLineBreaksOnReturn()) && (e.commands.exec("insertLineBreak"), 
                    a.preventDefault());
                }
            });
        }
...
(function(b) {
    ...
    b.views.Composer.prototype.style = function() {
        ...
        if (k.setActive) try {
            ...
            var t = k.style, u = a.documentElement.scrollTop || a.body.scrollTop, q = a.documentElement.scrollLeft || a.body.scrollLeft, t = {
                position: t.position,
                top: t.top,
                left: t.left,
    ...
    b.views.Composer.prototype.observe = function() {
        ...
        a.hasHistoryIssue() && a.supportsSelectionModify() && c.observe(i, "keydown", function(a) {
            if (a.metaKey || a.ctrlKey) {
                var b = a.keyCode, c = i.ownerDocument.defaultView.getSelection();
                if (37 === b || 39 === b) 37 === b && (c.modify("extend", "left", "lineboundary"), 
                a.shiftKey || c.collapseToStart()), 39 === b && (c.modify("extend", "right", "lineboundary"), 
                a.shiftKey || c.collapseToEnd()), a.preventDefault();
            }
        });
        ...
        c.observe(i, "keydown", function(a) {
            ...
            if (c && "IMG" === c.nodeName && (d === b.BACKSPACE_KEY || d === b.DELETE_KEY)) d = c.parentNode, 
            d.removeChild(c), "A" === d.nodeName && !d.firstChild && d.parentNode.removeChild(d), 
            setTimeout(function() {
                b.quirks.redraw(i);
            }, 0), a.preventDefault();
        });
        ...
        c.observe(i, "mouseover", function(a) {
            ...
            !("A" !== b && "IMG" !== b) && !a.hasAttribute("title") && (b = k[b] + (a.getAttribute("href") || a.getAttribute("src")), 
    ...
    b.views.Synchronizer = Base.extend({
        ...
        _observe: function() {
            ...
            this.editor.on("change_view", function(b) {
                "composer" === b && !c ? (a.fromTextareaToComposer(!0), e()) : "textarea" === b && (a.fromComposerToTextarea(!0), 
                f());
            });
...
(function(b) {
    ...
    b.toolbar.Dialog = b.lang.Dispatcher.extend({
        ...
        _interpolate: function(a) {
            for (var b, c, f = document.querySelector(":focus"), h = this.container.querySelectorAll("[data-wysihtml5-dialog-field]"), i = h.length, g = 0; g < i; g++) b = h[g], 
            b !== f && !(a && "hidden" === b.type) && (c = b.getAttribute("data-wysihtml5-dialog-field"), 
            c = this.elementToChange ? this.elementToChange[c] || "" : b.defaultValue, b.value = c);
        },
        show: function(a) {
            if (!c.hasClass(this.link, "wysihtml5-command-dialog-opened")) {
...
(function(b) {
    ...
    b.toolbar.Toolbar = Base.extend({
        ...
        _getLinks: function(a) {
            for (var c = this[a + "Links"] = b.lang.array(this.container.querySelectorAll("[data-wysihtml5-" + a + "]")).get(), e = c.length, f = 0, h = this[a + "Mapping"] = {}, i, g, j, k, m; f < e; f++) i = c[f], 
            j = i.getAttribute("data-wysihtml5-" + a), k = i.getAttribute("data-wysihtml5-" + a + "-value"), 
            g = this.container.querySelector("[data-wysihtml5-" + a + "-group='" + j + "']"), 
            m = this._getDialog(i, j), h[j + ":" + k] = {
                link: i,
                group: g,
                name: j,
                value: k,
        ...
        _observe: function() {
            ...
            c.delegate(e, "[data-wysihtml5-command], [data-wysihtml5-action]", "mousedown", function(a) {
                a.preventDefault();
            });
        ...
        _updateLinkStates: function() {
            ...
            for (e in a) h = a[e], this.commandsDisabled ? (f = !1, c.removeClass(h.link, "wysihtml5-command-active"), 
            h.group && c.removeClass(h.group, "wysihtml5-command-active"), h.dialog && h.dialog.hide()) : (f = this.composer.commands.state(h.name, h.value), 
            b.lang.object(f).isArray() && (f = 1 === f.length ? f[0] : !0), c.removeClass(h.link, "wysihtml5-command-disabled"), 
            h.group && c.removeClass(h.group, "wysihtml5-command-disabled")), h.state !== f && ((h.state = f) ? (c.addClass(h.link, "wysihtml5-command-active"), 
            h.group && c.addClass(h.group, "wysihtml5-command-active"), h.dialog && ("object" === typeof f ? h.dialog.show(f) : h.dialog.hide())) : (c.removeClass(h.link, "wysihtml5-command-active"), 
            h.group && c.removeClass(h.group, "wysihtml5-command-active"), h.dialog && h.dialog.hide()));
            for (e in d) a = d[e], "change_view" === a.name && (a.state = this.editor.currentView === this.editor.textarea, 
            a.state ? c.addClass(a.link, "wysihtml5-action-active") : c.removeClass(a.link, "wysihtml5-action-active"));
        },
        show: function() {
            this.container.style.display = "";
        },
