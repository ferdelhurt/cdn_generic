...
(function(m, ma) {
    ...
    function Yb(a, b, e) {
        ...
        function u() {
            o = b.contentHeight ? b.contentHeight : b.height ? b.height - (P ? P.height() : 0) - Sa(E) : Math.round(E.width() / Math.max(b.aspectRatio, .5));
        }
        function fa(k) {
            F++;
            n.setHeight(o, k);
        ...
        function ga(k) {
            if (!b.lazyFetching || ya(n.visStart, n.visEnd)) ra(); else k && da();
        }
        function ra() {
        ...
        function p(k, D, Z) {
            if (k instanceof Date) r = N(k); else yb(r, k, D, Z);
            S();
        }
        function L(k, D, Z) {
            k !== ma && gb(r, k);
                ...
                m.each(this.split(","), function(ra, sa) {
                    if (sa == "title") {
                        ...
                        if (ha) {
                            ...
                            var da = jb(b.buttonText, sa), na = m("<span class='fc-button fc-button-" + sa + " " + q + "-state-default'><span class='fc-button-inner'><span class='fc-button-content'>" + (ra ? "<span class='fc-icon-wrap'><span class='ui-icon ui-icon-" + ra + "'/></span>" : da) + "</span><span class='fc-button-effect'><span></span></span></span></span>");
                            if (na) {
                                na.click(function() {
    ...
    function Rb(a, b, e) {
        ...
        function X(h, O) {
            Ra.start(function(x) {
                B();
                if (x) if (pa(x)) ga(x.row, x.col, x.row, x.col); else {
                    x = na(x);
        ...
        function S(o, s, v) {
            ...
            s.draggable({
                ...
                stop: function(I, R) {
                    ...
                    if (V && (k || D || M)) C(this, o, k, M ? 0 : D, M, I, R); else {
                        r();
                        s.css("filter", "");
                        s.css(J);
                        F(0);
    ...
    function Kb(a, b, e) {
        ...
        function S(G, p) {
            ca.push(p);
            if (ka[G._id]) ka[G._id].push(p); else ka[G._id] = [ p ];
        }
        function Q() {
            ca = [];
            ka = {};
    ...
    function Qb() {
        ...
        function g(i, C, P) {
            ...
            for (E = 0; E < B; E++) {
                ...
                if (Y = n.element) {
                    W = n.event;
                    if (W._id === P) H(W, Y, n); else Y[0]._fci = E;
                }
            }
            Db(C, i, H);
        }
