        ...
        transition: function() {
            ...
            if (c.use_percentage && !j) i("bootstrap-progressbar: you can't use percentage without data-percentage being set"); else {
                ...
                if (c.display_text === a.fn.progressbar.display_text.center && !g && !f) {
                    ...
                    d.prepend(g);
                    var b;
                    l ? (b = e.css("height"), f.css("height", b), f.css("line-height", b), g.css("height", b), 
                    g.css("line-height", b), a(window).resize(function() {
                        b = e.css("height");
                        f.css("height", b);
                        f.css("line-height", b);
                        g.css("height", b);
                ...
                setTimeout(function() {
                    ...
                    var r = setInterval(function() {
                        ...
                        c.display_text !== a.fn.progressbar.display_text.none && (o = c.use_percentage ? b + "%" : i + " / " + k, 
                        c.display_text === a.fn.progressbar.display_text.filled ? d.text(o) : c.display_text === a.fn.progressbar.display_text.center && (f.text(o), 
                        g.text(o)));
                        p(b);
                    }, c.refresh_speed);
                }, c.transition_delay);
